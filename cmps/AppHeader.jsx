  ...
  render() {
    ...
    return (
      <header className="app-header">
          ...
          <a className="navbar-brand" href="#">AppSus</a>
          
          <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent19" aria-controls="navbarSupportedContent19" aria-expanded="false" aria-label="Toggle navigation"><span className="navbar-toggler-icon"></span></button>

          <div className="collapse navbar-collapse" id="navbarSupportedContent19">

            <ul className="navbar-nav mr-auto">
              <li className="nav-item"><NavLink className="nav-link" to="/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
              ...
              <li className="nav-item disable"><NavLink className="nav-link" to="/notes">
              ...
              <li className="nav-item disable"><NavLink className="nav-link" to="/books">
              ...
              <li className="nav-item">
                  <NavLink className="nav-link" to="/email/inbox">
